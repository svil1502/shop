        ...
        <div class="container">
            ...
            <div class="replay-box">
                <div class="row">
                    ...
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="checkme" id="agree" onclick="$('#modal').modal('show');"value="">
                            <i class="fa fa-2x icon-checkbox"></i>
                            Настоящим подтверждаю, что ознакомлен и согласен с условиями политики конфиденциальности.
                        </label>
                    </div>
